                    ...
                    <div className="flex min-h-full items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="space-y-2 text-gray-700 pb-4">
                                <div className="pl-6 pr-6 flex items-center justify-between gap-2 ">
                                    {
                                        specialPrice ? (
                                ...
                                <Divider />
                                <p className="pt-1 ml-6 ">{description}</p>
                                </div>
                            </div>
                            ...
                            <div className="px-6 py-4 flex justify-end gap-4">
                                <button onClick={() => setOpen(false)}
                                        type="button"
                                        className="px-4 py-2 text-sm font-semibold text-slate-700 border hover:text-slate-800 hover:border-slate-800 rounded-md cursor-pointer"
                                >
                                    Close
                                </button>
                            </div>
